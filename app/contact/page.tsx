      ...
      <div className="w-full max-w-[610px] px-6 py-12 space-y-12">
        <section className="space-y-6">
          ...
          <p className="text-foreground leading-normal text-sm md:text-base">
            ...
            in <strong>Nepal</strong> and {getAvailabilityMessage()}. Feel free
                ...
                <div className="flex gap-2">
                  {["general", "help"].map((c) => (
                    <button
                      ...
                      className={`px-6 h-12 rounded-xl flex items-center justify-center text-sm font-medium transition-all cursor-pointer ${
                        formData.category === c
                          ? "bg-foreground/10 border-foreground/20 scale-95"
