...
const timelineEntries = [
  ...
  },
  {
    ...
    description: "Started collaborating with local businesses and international clients to deliver custom digital solutions and landing pages.",
  },
  {
    year: "2023",
    title: "The Beginning",
    description: "Fell in love with coding after building my first simple website. Spent the year learning the fundamentals of HTML, CSS, and JavaScript.",
  },
];
      ...
      <div className="w-full max-w-[610px] px-6 py-12 space-y-24">
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-6 text-[17px] leading-relaxed text-foreground/80 font-normal">
            <p className="text-foreground text-2xl font-myfont">
