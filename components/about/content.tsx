...
export function AboutContent({ bio, socialLinks }: AboutContentProps) {
        ...
        <>
            <div className="grid grid-cols-1 md:grid-cols-[8fr_2fr] gap-8 items-center">
                <div>
                    <ReactMarkdown
                        ...
                        components={{
                            ...
                            strong: ({ children }) => <span className="font-bold font-myfont text-xl text-foreground">{children}</span>,
                        }}
                    >
                        {bio.replace(/\*\*\s+/g, '**')}
                    </ReactMarkdown>
                ...
                <div className="flex flex-col items-center md:items-end gap-6">
                    <Firfirey forceSpin={toggleState} />
                </div>
            </div>
            <div className="flex flex-row items-center justify-between w-full gap-4">
                ...
                <div className="scale-75 origin-right">
                    <ToggleButton onToggle={setToggleState} />
                </div>
            </div>
        </>
    );
